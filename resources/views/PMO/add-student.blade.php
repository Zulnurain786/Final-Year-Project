  ...
  @endif --}}
      <section class="section mt-3">
        <div class="container d-flex justify-content-center">
          <div class="row  w-75">
            <h2 class="d-flex justify-content-center mb-5" style="color: #4040a2;">ADD Student</h2>
            <div class="col-lg-12">
              <form action="{{route('PMO.addstudentrecord')}}" method="POST">
                @csrf
                        ...
                        <div class="row mb-4 mt-2">
                          <div class="col">
                            <div class="form-outline">
                              ...
                              <input type="text" id="form6Example10" class="form-control" placeholder="ex# 20-Arid-4567" name="regno" pattern="[0-9]{2}-[a-rA-R]{4}-[0-9]{4,3}" required/>
                            </div>
                          </div>
                          <div class="col">
                            <div class="form-outline">
