  ...
  @endif --}}
      <section class="section mt-3">
        <div class="container d-flex justify-content-center">
          <div class="row  w-75">
            <h2 class="d-flex justify-content-center mb-5" style="color: #4040a2;">Add New PMO</h2>
            <div class="col-lg-12">
              <form action="{{URL::to('PMO/addnewpmo')}}" method="POST">
                @csrf
                 <div class="mb-4 border rounded">
                    <div class="m-3">
                      ...
                      <div class="row mb-4">
                        <div class="col">
                          <div class="form-outline">
                            ...
                            <input type="text" id="form6Example1" class="form-control" name="name" placeholder="PMO" required />
                          </div>
                        </div>
                        <div class="col">
                          <div class="form-outline">
                            <label class="form-label" for="form6Example2">Session</label>
                            <select id="form6Example2" class="form-control" name="session" required>
                      ...
                      <!-- <div class="form-outline mb-4">
                            ...
                            <input type="text" id="form6Example3" class="form-control" placeholder="ex# Bilal" required />
                      </div> -->
                  </div>
                  </div>
                <div class="mb-4 border rounded">
