    ...
    <main>
      ...
      <section class="section mt-3">
        <div class="container d-flex justify-content-center">
          <div class="row  w-75">
            <h2 class="d-flex justify-content-center mb-5" style="color: #4040a2;">Update Preliminary Proposal Form</h2>
            <div class="col-lg-12">
              <form action="{{URL::to('PMO/saveupdatepreliminarypurposel')}}" method="POST">
                @csrf
                    ...
                    <div class="m-3">
                      ...
                      <div class="row mb-4">
                        ...
                        <div class="col">
                          <div class="form-outline">
                            ...
                            <input type="text" id="form6Example2" class="form-control" placeholder="No.Of Members" pattern="[1-3]{1}" value="{{$purposelrecord->studentgroup->groupmembers}}" disabled/>
                            <input type="hidden" id="form6Example2" class="form-control" placeholder="No.Of Members" pattern="[1-3]{1}" value="{{$purposelrecord->id}}" name="id"/>
                          </div>
                        </div>
                      </div>
                      <!-- Text input -->
                      <div class="form-outline mb-4">
                            ...
                            <select name="superviser" id="select" class="form-control" onchange="" required>
                              {{-- <option value="{{$purposelrecord->superviserid}}">{{$purposelrecord->supervisor->name}} [Current]</option> --}}
                              @foreach ($allsuperviser as $item)
                              <option value="{{ $item['id'] }}">
                                {{ $item['id'] == $purposelrecord->superviserid ? $item['name'] . ' (Current)' : $item['name'] }}
                            </option>
                              @endforeach
                            </select>
                ...
                <div class="form-outline mb-4 border rounded">
                  <div class="m-3">
                    ...
                    <input type="text" id="form6Example56" class="form-control" name="projectname" value="{{$purposelrecord->projectname}}" required/>
                ...
                <div class="form-outline mb-4 border rounded">
                  <div class="m-3">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea12" rows="3" name="electivecourses" required>{!!$purposelrecord->electivecourses!!}</textarea>
                  </div>
                </div>
                ...
                <div class="form-outline mb-4 border rounded">
                  <div class="m-3">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea13" rows="3" name="plt" required>{!!$purposelrecord->programminglanguagetools!!}</textarea>
                  </div>
                </div>
