        ...
        <div class="container-fluid px-4">
            <Form class="mt-2 mb-5">
                <div class="form-outline w-25">
                    ...
                    <select name="select" id="selectsuperviser" class="form-control" onchange="allsupervisorreloadPage()" required>
            ...
            <h3 class="mt-4" style="color: #4040a2;">All Supervisor</h3>
                                ...
                                <td class="purposelbutton" style="text-align: center;">
                                      ...
                                      <div class="dropdown-center d-flex justify-content-center">
                                            ...
                                            <ul class="dropdown-menu" style="display:none;">
                                                ...
                                                {{-- <li><a class="dropdown-item btn btn-sm text-secondary" href="{{URL::to('PMO/all-sessions-of-superviser/'.$item->id)}}"><i class="fa-solid fa-file fa-lg me-2"></i>Finel Evalution Form</a></li> --}}
                                                <li><hr class="m-0"></li>
                                                <li><a class="dropdown-item btn btn-sm text-danger mt-1" href="{{URL::to('PMO/all-sessions-of-superviser/'.$item->id)}}"><i class="fa-regular fa-trash-can fa-lg  me-1" style="color: #df0707;"></i>Delete</a></li>
                                            </ul>
                                       </div>
