          ...
          <div class="col-md-12">
            <div class="_lk_de">
              <div class="form-03-main">
                ...
                <form action="{{route('PMO.login')}}" method="POST">
                  @csrf
                  ...
                  <div class="form-group">
                    ...
                    <div class="d-flex justify-content-end">
                      <a href="{{URL::to('PMO/forgetpassword')}}" class="text-decoration-none" style="color: #2b3990;">Forget Password!</a>
                    </div>
                  </div>
                ...
                <div class="form-groupl">
                  <div class="_btn_04">
                    <a href="{{URL::to('supervisor-login')}}">Login as Supervisor</a>
                  </div>
                </div>
...
<html lang="en">
  ...
  <div class="d-lg-flex half">
    ...
    {{-- <div id="carouselExampleInterval" class="bg order-1 order-md-2 carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner"  style="height: 100%">
        <div class="carousel-item active" style="height: 100%" data-bs-interval="10000">
          <img src="{{URL::to('../Images/student1.jpg')}}" style="object-fit: cover;" class="d-block w-100 h-100" alt="...">
        </div>
        <div class="carousel-item h-100" data-bs-interval="2000">
          <img src="{{URL::to('../Images/student2.jpg')}}" style="object-fit: cover;" class="d-block w-100 h-100" alt="...">
        </div>
        <div class="carousel-item h-100">
          <img src="{{URL::to('../Images/student3.jpg')}}" style="object-fit: cover;" class="d-block w-100 h-100" alt="...">
        </div>
      </div>
            ...
            <form action="{{route('PMO.login')}}" method="POST">
              ...
              <div class="social-login">
                <a href="{{URL::to('student-login')}}" class="facebook btn d-flex justify-content-center align-items-center">
                  <span class="icon-facebook mr-3"></span> Student
                </a>
