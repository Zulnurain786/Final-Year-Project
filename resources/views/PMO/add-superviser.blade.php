    ...
    <main>
      <section class="section mt-3">
        <div class="container d-flex justify-content-center">
          <div class="row  w-75">
            <h2 class="d-flex justify-content-center mb-5" style="color: #4040a2;">ADD Supervisor</h2>
            <div class="col-lg-12">
              <form action="{{route('PMO.addnewsuperviser')}}" method="POST">
                @csrf
                        ...
                        <div class="col">
                           <!-- Text input -->
                            <div class="form-outline mb-4">
                              ...
                              <input type="text" id="form6Example3" class="form-control" placeholder="ex# Bilal" name="name" required />
                            </div>
                        ...
                        <div class="row mb-4 mt-2">
                          <div class="col">
                            <div class="form-outline">
                              ...
                              <input type="text" id="form6Example10" class="form-control" placeholder="ex# Web Development" name="Domain" required/>
                          </div>
                          </div>
                          <div class="col">
                            <div class="form-outline">
                              <label class="form-label" for="form6Example20">Phone Number</label>
                              <input type="tel" id="form6Example20" class="form-control" placeholder="ex# 03001234567" pattern="[0-9]{4}[0-9]{7}" name="pnumber" required/>
                            </div>
                          </div>
                          <!-- <div class="col">
                            <div class="form-outline">
                      ...
                      <div class="form-outline mb-4">
                        ...
                        <div class="row mb-4 mt-2">
                          ...
                          <div class="col">
                            <div class="form-outline">
                              <label class="form-label" for="form6Example30">Email</label>
                              <input type="email" id="form6Example30" class="form-control" placeholder="Email" name="email" required/>
                            </div>
                          </div>
                          <div class="col">
                            <div class="form-outline">
                              <label class="form-label" for="form6Example40">Password</label>
                              <input type="password" id="form6Example40" class="form-control" placeholder="********" name="password" required/>
                            </div>
                          </div>
                        </div>
                      </div>
