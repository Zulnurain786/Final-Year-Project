              ...
              <div class="form-03-main">
                <div class="row">
                  <div class="col-md-12 d-flex align-items-center justify-content-center">
                      <div class="">
                        <h1 class="ms-sm-4 ms-md-2" style="color: #2b3990;">PMO</h1>
                      </div>
                  </div>
                </div>
                <div class="logo">
                ...
                <form action="{{route('PMO.resetpassword')}}" method="POST">
                  @csrf
                  <div class="form-group">
                    <input type="hidden" name="id" class="form-control _ge_de_ol" aria-required="true" style="border-radius: 20px;" value="{{$id}}">
                    <input type="text" name="token" class="form-control _ge_de_ol" placeholder="Enter Email" required="" aria-required="true" style="border-radius: 20px;">
                  </div>
                  <div class="form-group">
                    <input type="type" name="password" class="form-control _ge_de_ol"  placeholder="Enter Email" required="" aria-required="true" style="border-radius: 20px;">
                  </div>
                  <div class="row">
                    <div class="col-md-12 d-flex align-items-center justify-content-center">
                      <div class="form-groupp ms-md-4 ms-sm-0">
                        <div class="">
                          <button type="submit" class="btn btn-primary border border-rounded" style="border-color: #2b3990 !important;background-color: #2b3990;">Reset Passsword</button>
                        </div>
                      </div>
                    </div>
                  </div>
...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="{{URL::to('../Images/nav-logo.png')}}" type="image/x-icon">
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            <div class="mb-4 d-flex align-items-center" style="flex-direction: column">
                <img src="{{URL::to('../Images/recover-2.png')}}" alt="" height="120px" width="120px" class="mb-3">
              <h3 style="color: #2a446c">Re-cover Password</h3>
            ...
            <form action="{{route('PMO.resetpassword')}}" method="POST">
              ...
              <div class="mb-3" style="color:#2a446c">
                ...
                <input type="hidden" name="id" class="form-control _ge_de_ol" aria-required="true" style="border-radius: 20px;" value="{{$id}}">
                <input type="text" class="form-control" name="token" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                <div id="emailHelp" class="form-text">Don't shere token with anyone else..</div>
              </div>
              <div class="mb-3" style="color:#2a446c">
