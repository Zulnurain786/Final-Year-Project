      ...
      <section class="section mt-3">
        <div class="container d-flex justify-content-center">
          <div class="row  w-75">
            ...
            <div class="col-lg-12">
              <form action="{{route('Student.updategrouplogin')}}" method="POST">
                @csrf
                      ...
                      <div class="row mb-4">
                        <div class="col">
                          <div class="form-outline">
                            ...
                            <input type="text" id="form6Example1" class="form-control" name="projectid" value="{{$loginrecord->projectid}}" disabled/>
                          </div>
                        </div>
                        <div class="col">
                          <div class="form-outline">
                            ...
                            <input type="text" id="form6Example2" class="form-control" name="password" value="{{$loginrecord->password}}" required/>
                          </div>
                        </div>
