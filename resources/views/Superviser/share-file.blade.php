...
<div id="layoutSidenav_content" style="background-color: #f7fbff;">
    <main>
        ...
        <div class="container-fluid mt-3">
            <div class="row">
                <div class="col-md-6">
                    <form action="{{route('Superviser.uploudfile')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <h5  style="color: #4040a2;">Share File</h5>
                        <div class="d-flex justify-content-start gap-5 mt-3 pt-1">
                            <div class="form-check mr-3">
                                <input class="form-check-input" type="checkbox" value="" name="pmo" id="flexCheckDefault">
                ...
                <div class="col-md-6">
                    <form action="{{ route('Superviser.uploudindividualfile') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <h5 style="color: #4040a2;">Group File Share</h5>
            ...
            <div class="row">
                <div class="col-12">
                    {{-- <form action="{{route('Superviser.uploudfile')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <h5  style="color: #4040a2;">Select To Share File</h5>
                        <div class="form-check mt-3">
                            <input class="form-check-input" type="checkbox" value="" name="pmo" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">
                                For PMO
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="purposelbutton" style="text-align: center;">
                                                    <a href="{{URL::to('Superviser/openFile/'.$item->id)}}" class="btn text-info border border-info btn-sm ms-3"><i class="fa-solid fa-file-pen fa-xl"></i>View</a>
                                                    ...
                                                    <a href="{{URL::to('Superviser/deletefile/'.$item->id)}}" class="btn btn-sm text-danger border border-danger  ms-3"><i class="fa-regular fa-trash-can fa-lg  me-1" style="color: #df0707;"></i>Delete</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
