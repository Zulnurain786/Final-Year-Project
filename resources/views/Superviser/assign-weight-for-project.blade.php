  ...
  @endif --}}
      <section class="section mt-3">
        <div class="container d-flex justify-content-center">
          <div class="row  w-75">
            <h2 class="d-flex justify-content-center mb-5" style="color: #4040a2;">ASSIGN WEIGHT</h2>
            <div class="col-lg-12">
                      ...
                      <div class="row mb-4">
                        <div class="col-md-6">
                          <div class="form-outline">
                            ...
                            <input id="addinput" name="name" type="text" class="form-control" value="{{ old('name') }}" placeholder="Enter Heading Name" >
                            <!-- <input type="text" id="form6Example2" class="form-control" placeholder="ex# Fall-2020" required/> -->
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-outline">
                            <label class="form-label" for="form6Example2">Value</label>
                 ...
                 <div class="mb-4 border rounded">
                  <div class="m-3">
                    <form action="{{route('Superviser.saveweightform')}}" method="POST">
                      @csrf
