    ...
    <main>
      <section class="section mt-3">
        <div class="container d-flex justify-content-center">
          <div class="row  w-75">
            <h2 class="d-flex justify-content-center mb-5" style="color: #4040a2;">Profile</h2>
            <div class="col-lg-12">
              <form action="{{route('Superviser.updateprofile')}}" method="POST">
                @csrf
                        ...
                        <div class="col-md-12">
                           <!-- Text input -->
                            <div class="form-outline mb-4">
                              <label class="form-label" for="form6Example3">Superviser Name</label>
                              <input type="text" id="form6Example3" class="form-control" placeholder="ex# Bilal" name="name" value="{{$supervisor->name}}" required />
                            </div>
                          {{-- <div class="form-outline">
                            <label class="form-label" for="form6Example1">Porgrammer Semester</label>
                            <input type="text" id="form6Example1" class="form-control" placeholder="7th" value="7th" disabled />
                          </div> --}}
                        </div>
                        <div class="col">
                          <div class="form-outline">
                  ...
                  <div class="m-3">
                      <div class="form-outline mb-4">
                        ...
                        <div class="row mb-4 mt-2">
                          <div class="col-md-6">
                            <div class="form-outline">
                              <label class="form-label" for="form6Example10">Domain</label>
                              <input type="text" id="form6Example10" class="form-control" placeholder="ex# Web Development" name="Domain" value="{{$supervisor->domain}}"  required/>
                          </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-outline">
                              <label class="form-label" for="form6Example20">Phone Number</label>
                              <input type="tel" id="form6Example20" class="form-control" placeholder="ex# 03001234567" pattern="[0-9]{4}[0-9]{7}" value="{{$supervisor->pnumber}}"  name="pnumber" required/>
                            </div>
                          </div>
                          <!-- <div class="col">
                            <div class="form-outline">
                      ...
                      <div class="form-outline mb-4">
                        ...
                        <div class="row mb-4 mt-2">
                          ...
                          <div class="col-md-6">
                            <div class="form-outline">
                              <label class="form-label" for="form6Example30">Email</label>
                              <input type="email" id="form6Example30" class="form-control" placeholder="Email" name="email" value="{{$supervisor->email}}"  required/>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-outline">
                              <label class="form-label" for="form6Example40">Password</label>
                              <input type="text" id="form6Example40" class="form-control" value="{{$supervisor->password}}"  name="password" required/>
                            </div>
                          </div>
                        </div>
                      </div>
