...
<table style="width:100%">
  ...
  <tr>
    <td style="border:1px solid #808080;  height:30px; text-align:center">Presentation <br> (_)</td>
    <td style="border:1px solid #808080;  height:30px; text-align:center">SRS <br> (_)</td>
    <td style="border:1px solid #808080;  height:30px; text-align:center">Supervisor <br> (_)</td>
    <td style="border:1px solid #808080;  height:30px; text-align:center">Total <br> (_)</td>
  </tr>
  <tr> 
...
<br> 
     <p><b>Note: In SRS check the following:</b></p>
 <table style="width:100%" border="1">
   <tr>
      <th style="border:1px solid #808080; width:130px text-align:center ;height:30px">SRS Components</th>
      <th style="border:1px solid #808080; width:90px; text-align:center; height:30px">Tick</th>
      <th style="border:1px solid #808080; width:240px;  text-align:center;  height:30px">SRS Components</th>
      <th style="border:1px solid #808080; width:90px; text-align:center;  height:30px">Tick</th>
   </tr>
   <tr>
      <td style="border:1px solid #808080; height:30px">Project Features </td>
      <td style="border:1px solid #808080;  height:30px"></td>
      <td style="border:1px solid #808080;  height:30px">Traceability</td>
      <td style="border:1px solid #808080;  height:30px"></td>
   </tr>
   <tr>
      <td style="border:1px solid #808080;  height:30px">Stakeholders</td>
      <td style="border:1px solid #808080;  height:30px"></td>
      <td style="border:1px solid #808080;  height:30px">System Sequence Diagram</td>
      <td style="border:1px solid #808080;  height:30px"></td>   </tr>
   <tr>
      <td style="border:1px solid #808080;  height:30px">Functional Requirements</td>
      <td style="border:1px solid #808080;  height:30px"></td>
      <td style="border:1px solid #808080;  height:30px">Use Case</td>
      <td style="border:1px solid #808080;  height:30px"></td>   </tr>
   <tr>
      <td style="border:1px solid #808080;  height:30px">Non-Functional Requirements</td>
      <td style="border:1px solid #808080;  height:30px"></td>
      <td style="border:1px solid #808080;  height:30px">DFD Level 0 and 1</td>
      <td style="border:1px solid #808080;  height:30px"></td>   </tr>
      <tr>
         <td style="border:1px solid #808080;  height:30px">Constraints</td>
         <td style="border:1px solid #808080;  height:30px"></td>
         <td style="border:1px solid #808080;  height:30px">Block Diagram / Concept Diagram</td>
         <td style="border:1px solid #808080;  height:30px"></td>   </tr>
         <tr>
          <td style="border:1px solid #808080;  height:30px">Functionality Classification  </td>
          <td style="border:1px solid #808080;  height:30px"></td>
          <td style="border:1px solid #808080;  height:30px"></td>
          <td style="border:1px solid #808080;  height:30px"></td>
        </tr>
